...
export class HUDMobileControls extends BaseHUDPart {
    createElements(parent) {
        ...
        this.element.appendChild(this.rotateButton);
        ...
        this.element.appendChild(this.multiplaceButton);
    ...
    initialize() {
        ...
        this.rotateAttach = new DynamicDomAttach(this.root, this.rotateButton);
    }
    ...
    update() {
        ...
        this.rotateAttach.update(isPlacingBuilding);
